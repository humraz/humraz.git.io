...
function Subcard(props) {
    ...
    return(
            ...
            {showModal ? (
                <>
                <div
                    className="justify-center items-center flex flex-col overflow-auto  fixed inset-0 z-50 outline-none focus:outline-none">
